 ...
 PxVehicle4W* veh)
{
	...
	PxConstraintDesc suspLimitConstDesc;
	suspLimitConstDesc.actor[0]=veh->mActor;
	suspLimitConstDesc.actor[1]=NULL;
	suspLimitConstDesc.connector=&veh->getVehicletConstraintShader();
	suspLimitConstDesc.dataSize=sizeof(PxVehicleConstraintShader<PxVehicle4WSimulationData::eNUM_WHEELS>::VehicleConstraintData);
	suspLimitConstDesc.flags=PxConstraintFlags();
	suspLimitConstDesc.solverPrep=PxVehicleConstraintShader<PxVehicle4WSimulationData::eNUM_WHEELS>::updateConstraints;		
	suspLimitConstDesc.visualize=PxVehicleConstraintShader<PxVehicle4WSimulationData::eNUM_WHEELS>::visualiseConstraint;
	veh->getVehicletConstraintShader().mConstraint=physics->createConstraint(suspLimitConstDesc);
