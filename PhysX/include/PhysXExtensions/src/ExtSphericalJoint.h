...
#include "deprecated/PxSphericalJointDesc.h"
...
//~PX_SERIALIZATION
		...
		static ConstraintInternalInterface* create(const PxSphericalJointDesc& desc)
		{
			return PX_NEW(SphericalJoint)(desc);
		}

		SphericalJoint(const PxSphericalJointDesc& desc): SphericalJointT(desc)
		 {
// PX_SERIALIZATION
...
//~PX_SERIALIZATION
			...
			data->limit = desc.coneLimit;
			data->jointFlags = desc.sphericalJointFlags;
		 }
