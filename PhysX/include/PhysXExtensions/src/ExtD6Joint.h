...
#include "ExtJoint.h"
#include "PxD6Joint.h"
#include "deprecated/PxD6JointDesc.h"
...
namespace Ext
{
	struct D6JointData : public JointData
	{
		...
		PxReal                  linearPad;		// linear limit padding
...
//~PX_SERIALIZATION
		...
		static ConstraintInternalInterface* create(const PxD6JointDesc& desc)
		{
			return PX_NEW(D6Joint)(desc);
		}

		D6Joint(const PxD6JointDesc& desc);
	...
	private:
		...
		void* prepareData();
		void finishDesc(PxConstraintDesc&);
