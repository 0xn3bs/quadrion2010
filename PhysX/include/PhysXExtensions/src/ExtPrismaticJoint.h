...
#include "deprecated/PxPrismaticJointDesc.h"
...
//~PX_SERIALIZATION
		...
		static ConstraintInternalInterface* create(const PxPrismaticJointDesc& desc)
		{
			return PX_NEW(PrismaticJoint)(desc);
		}

		PrismaticJoint(const PxPrismaticJointDesc& desc): PrismaticJointT(desc)
		 {
// PX_SERIALIZATION
