...
namespace Ext
{
	namespace joint
	{
		...
		void visualizeFrames(Cm::RenderOutput& out,
							 PxReal scale,
							 const PxTransform& parent,
							 const PxTransform& child);

		void visualizeLinearLimit(Cm::RenderOutput& out,
								  PxReal scale,
		...
		void visualizeAngularLimit(Cm::RenderOutput& out,
								   PxReal scale,
								   const PxTransform& t0,
								   PxReal lower,
								   PxReal upper,
		...
		void visualizeLimitCone(Cm::RenderOutput& out,
								PxReal scale,
								const PxTransform& t,
								PxReal ySwing,
								PxReal zSwing,
		...
		void visualizeDoubleCone(Cm::RenderOutput& out,
								 PxReal scale,
								 const PxTransform& t,
								 PxReal angle,
								 bool active);
