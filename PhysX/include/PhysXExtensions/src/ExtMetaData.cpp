...
void RevoluteJoint::getMetaData(PxSerialStream& stream)
{
	...
	DEFINE_MD_BASE_CLASS(RevoluteJoint, ConstraintInternalInterface)
...
#endif
	DEFINE_MD_ITEM(RevoluteJoint,	PxConstraint,	mShader,	MdFlags::ePTR)
...
void SphericalJoint::getMetaData(PxSerialStream& stream)
{
	...
	DEFINE_MD_BASE_CLASS(SphericalJoint, ConstraintInternalInterface)
...
#endif
	DEFINE_MD_ITEM(SphericalJoint,	PxConstraint,	mShader,	MdFlags::ePTR)
...
void DistanceJoint::getMetaData(PxSerialStream& stream)
{
	...
	DEFINE_MD_BASE_CLASS(DistanceJoint, ConstraintInternalInterface)
...
#endif
	DEFINE_MD_ITEM(DistanceJoint,	PxConstraint,	mShader,	MdFlags::ePTR)
...
static void getMetaData_D6JointData(PxSerialStream& stream)
{
	...
	DEFINE_MD_ITEM(D6JointData,		PxReal,				linearPad,					0)
...
void D6Joint::getMetaData(PxSerialStream& stream)
{
	...
	DEFINE_MD_BASE_CLASS(D6Joint, ConstraintInternalInterface)
...
#endif
	DEFINE_MD_ITEM(D6Joint,		PxConstraint,	mShader,			MdFlags::ePTR)
...
void PrismaticJoint::getMetaData(PxSerialStream& stream)
{
	...
	DEFINE_MD_BASE_CLASS(PrismaticJoint, ConstraintInternalInterface)
...
#endif
	DEFINE_MD_ITEM(PrismaticJoint,	PxConstraint,	mShader,	MdFlags::ePTR)
...
void FixedJoint::getMetaData(PxSerialStream& stream)
{
	...
	DEFINE_MD_BASE_CLASS(FixedJoint, ConstraintInternalInterface)
...
#endif
	DEFINE_MD_ITEM(FixedJoint,	PxConstraint,	mShader,	MdFlags::ePTR)
...
void PxRegisterExtJointMetaData(PxSerialStream& stream)
{
	...
	DEFINE_MD_VCLASS(ConstraintInternalInterface)
