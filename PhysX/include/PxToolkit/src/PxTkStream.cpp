...
{
	PxU8 b;
	Ps::memCopy(&b, buffer, sizeof(PxU8));
	buffer += sizeof(PxU8);
	return b;
}
...
{
	PxU16 w;
	Ps::memCopy(&w, buffer, sizeof(PxU16));
	buffer += sizeof(PxU16);
	return w;
}
...
{
	PxU32 d;
	Ps::memCopy(&d, buffer, sizeof(PxU32));
	buffer += sizeof(PxU32);
	return d;
}
...
{
	float f;
	Ps::memCopy(&f, buffer, sizeof(float));
	buffer += sizeof(float);
	return f;
}
...
{
	double f;
	Ps::memCopy(&f, buffer, sizeof(double));
